...
class ReceiptRuRegionHomeScreen extends StatefulWidget {
  @override
  _ReceiptRuRegionHomeScreenState createState() => _ReceiptRuRegionHomeScreenState();
}
...
class _ReceiptRuRegionHomeScreenState extends State<ReceiptRuRegionHomeScreen>
  ...
  void initState() {
    ...
    tabBody = ReceiptRuregionCartListScreen(animationController: animationController);
    super.initState();
