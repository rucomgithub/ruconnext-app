...
class SuccessRuregionCartListView extends StatefulWidget {
  const SuccessRuregionCartListView(
  ...
  @override
  _SuccessRuregionCartListViewState createState() =>
      _SuccessRuregionCartListViewState();
}

class _SuccessRuregionCartListViewState
    extends State<SuccessRuregionCartListView> with TickerProviderStateMixin {
