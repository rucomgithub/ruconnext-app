...
import 'package:th.ac.ru.uSmart/ruregionApp/ruregionsuccess/button_success_view.dart';
import 'package:th.ac.ru.uSmart/ruregionApp/ruregionsuccess/success_location_exam.dart';
import 'package:th.ac.ru.uSmart/ruregionApp/ruregionsuccess/success_profile_region_cart_view.dart';
...
import 'success_register_region_list_view.dart';
import 'success_register_region_view.dart';

class SuccessRuregionCartListScreen extends StatefulWidget {
  const SuccessRuregionCartListScreen({Key? key, this.animationController})
      : super(key: key);

  final AnimationController? animationController;
  @override
  _SuccessRuregionCartListScreenState createState() =>
      _SuccessRuregionCartListScreenState();
}

class _SuccessRuregionCartListScreenState
    extends State<SuccessRuregionCartListScreen> with TickerProviderStateMixin {
