...
class RuregionCartView extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  const RuregionCartView({Key? key, this.animationController, this.animation})
      : super(key: key);

  @override
  State<RuregionCartView> createState() => _RuregionCartViewState();
}

class _RuregionCartViewState extends State<RuregionCartView> {
