...
class RuregionCartNoDataView extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;
  final String? titleTxt;
  final String? subTxt;

  const RuregionCartNoDataView({
    Key? key,
  ...
  @override
  State<RuregionCartNoDataView> createState() => _RuregionCartNoDataViewState();
}

class _RuregionCartNoDataViewState extends State<RuregionCartNoDataView> {
