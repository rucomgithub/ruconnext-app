...
class RuregionMr30Screen extends StatefulWidget {
  const RuregionMr30Screen({Key? key, this.animationController}) : super(key: key);
...
class _RuregionMr30ScreenState extends State<RuregionMr30Screen> with TickerProviderStateMixin {
