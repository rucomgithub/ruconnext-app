...
class RegisHelpScreen extends StatefulWidget {
  const RegisHelpScreen({super.key});

  @override
  State<RegisHelpScreen> createState() => _RegisHelpScreenState();
}

class _RegisHelpScreenState extends State<RegisHelpScreen> {
  int _currentIndex = 0;
      ...
      child: Row(
        children: <Widget>[
          ...
          Expanded(
            child: Center(
              child: Text(
                'การใช้งานข้อมูลการลงทะเบียนเรียน',
                style: TextStyle(
