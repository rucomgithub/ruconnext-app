...
class NewsHelpScreen extends StatefulWidget {
  const NewsHelpScreen({super.key});

  @override
  State<NewsHelpScreen> createState() => _NewsHelpScreenState();
}

class _NewsHelpScreenState extends State<NewsHelpScreen> {
  int _currentIndex = 0;
