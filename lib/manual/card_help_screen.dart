...
class GradeHelpScreen extends StatefulWidget {
  const GradeHelpScreen({super.key});

  @override
  State<GradeHelpScreen> createState() => _GradeHelpScreenState();
}

class _GradeHelpScreenState extends State<GradeHelpScreen> {
  int _currentIndex = 0;
