...
class MR30HelpScreen extends StatefulWidget {
  const MR30HelpScreen({super.key});

  @override
  State<MR30HelpScreen> createState() => _MR30HelpScreenState();
}

class _MR30HelpScreenState extends State<MR30HelpScreen> {
  int _currentIndex = 0;
