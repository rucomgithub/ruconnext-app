...
import 'package:th.ac.ru.uSmart/rotcs/rotcs_extend_list_screen.dart';

String? tokenMr30;

class RotcsExtendHomeScreen extends StatefulWidget {
  @override
  _RotcsExtendHomeScreenState createState() => _RotcsExtendHomeScreenState();
}

class _RotcsExtendHomeScreenState extends State<RotcsExtendHomeScreen>
  ...
  void initState() {
    ...
    tabBody = RotcsExtendListScreen(animationController: animationController);
    super.initState();
  }
