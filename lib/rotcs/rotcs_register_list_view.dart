...
class RotcsRegisterListView extends StatelessWidget {
  ...
  final RotcsRegisterDetail? rotcslData;
                                    ...
                                    child: Container(
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Text(
                                              '${rotcslData!.typeReport} ชั้นปีที่ ${rotcslData!.layerReport}',
                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                Text(
                                                  'รายงานประจำปีการศึกษา ${rotcslData!.yearReport}',
                                                  style: TextStyle(
                                                      fontSize: 14,
                                                      color: Colors.grey
                                                          .withOpacity(0.8)),
                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                Text(
                                                  'สถานศึกษาวิชาทหาร ${rotcslData!.locationArmy}',
                                                  style: TextStyle(
                                                      fontSize: 14,
                                                      color: Colors.grey
                                                          .withOpacity(0.8)),
