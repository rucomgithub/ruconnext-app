...
class RuregionLoginPage extends StatefulWidget {
  const RuregionLoginPage({super.key});

  @override
  State<RuregionLoginPage> createState() => _RuregionLoginPageState();
}

class _RuregionLoginPageState extends State<RuregionLoginPage> {
  ...
  void doLogin(usr,pwd) {
       Provider.of<RuregisProvider>(context, listen: false).doLogin(context,usr,pwd);
