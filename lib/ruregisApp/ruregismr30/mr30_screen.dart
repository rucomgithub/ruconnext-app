...
class RuregisMr30Screen extends StatefulWidget {
  const RuregisMr30Screen({Key? key, this.animationController}) : super(key: key);

  final AnimationController? animationController;
  @override
  _RuregisMr30ScreenState createState() => _RuregisMr30ScreenState();
}

class _RuregisMr30ScreenState extends State<RuregisMr30Screen> with TickerProviderStateMixin {
