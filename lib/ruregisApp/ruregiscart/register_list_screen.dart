...
class RuregisCartListScreen extends StatefulWidget {
  const RuregisCartListScreen({Key? key, this.animationController})
      : super(key: key);

  final AnimationController? animationController;
  @override
  _RuregisCartListScreenState createState() => _RuregisCartListScreenState();
}

class _RuregisCartListScreenState extends State<RuregisCartListScreen>
