...
class RuregisCartListView extends StatefulWidget {
  const RuregisCartListView(
  ...
  @override
  _RuregisCartListViewState createState() => _RuregisCartListViewState();
}

class _RuregisCartListViewState extends State<RuregisCartListView>
