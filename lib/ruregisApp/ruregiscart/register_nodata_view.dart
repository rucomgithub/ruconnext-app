...
class RuregisCartNoDataView extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;
  final String? titleTxt;
  final String? subTxt;

  const RuregisCartNoDataView({
    Key? key,
  ...
  @override
  State<RuregisCartNoDataView> createState() => _RuregisCartNoDataViewState();
}

class _RuregisCartNoDataViewState extends State<RuregisCartNoDataView> {
