...
class RuregisCartView extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  const RuregisCartView({Key? key, this.animationController, this.animation})
      : super(key: key);

  @override
  State<RuregisCartView> createState() => _RuregisCartViewState();
}

class _RuregisCartViewState extends State<RuregisCartView> {
