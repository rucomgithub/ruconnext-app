            ...
            if (!snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final int count =
                      Category.categoryList.length > 10 ? 10 : mr30.length;
...
class CategoryView extends StatelessWidget {
  ...
  Container CourseCircle(RECORD catagory) {
    var daycolor = ColorDay(catagory.dayCode!);
    return Container(
      child: Padding(
          ...
          children: <Widget>[
            CircleAvatar(
              ...
              child: Column(
                ...
                children: [
                  Text(category!.courseNo.toString()),
                  Text(category!.courseCredit.toString()),
                ],
              ),
              radius: 40.0,
            )
